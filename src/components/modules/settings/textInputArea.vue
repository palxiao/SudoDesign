 ...
 * @LastEditTime: 2022-01-26 15:14:16
...
<template>
  <div id="text-input-area">
    ...
    <div :class="{ 'input-wrap': true, active: inputBorder }">
      <textarea :class="{ 'real-input': true, disable: !editable }" type="text" rows="3" :value="dealValue" :readonly="editable ? false : 'readonly'" @input="updateValue($event.target.value)" @focus="focusInput" @blur="blurInput" />
    </div>
  </div>
</template>
